package com.hs.spring_ai_rag_advance.advisor;
...
public class TokenPrintAdvisor implements CallAdvisor, StreamAdvisor {
	...
	public ChatClientResponse adviseCall(ChatClientRequest chatClientRequest, CallAdvisorChain callAdvisorChain) {
		...
		this.logger
				.info("Prompt Token : " + chatClientResponse.chatResponse().getMetadata().getUsage().getPromptTokens());
		this.logger.info("Completion Token : "
